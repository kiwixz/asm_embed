function (asm_embed prefix name file)
    ...
    configure_file("${CMAKE_SOURCE_DIR}/cmake/asm_embed.asm" "${CMAKE_CURRENT_BINARY_DIR}/${target}/source.asm" @ONLY)
    ...
    configure_file("${CMAKE_SOURCE_DIR}/cmake/asm_embed.h" "${CMAKE_CURRENT_BINARY_DIR}/${target}/include/embed/${name}.h" @ONLY)
